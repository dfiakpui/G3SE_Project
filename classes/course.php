<?php
	...
	class course extends adb{
		...
		* @param $year this shows the year that the course is being run
		...
		*This is the view a specific course code that queries the cdatabase and allows users to view a course.
