<?php
	...
	class faculty extends adb{
		...
		* @param $password this is the password of the faculty
		*/
		function edit_faculty($id, $firstname, $lastname,$status,$email,$telephone,$office_hour,$username,$pword){
			$str_query = "Update se_faculty set first_name='$firstname',last_name='$lastname', status='$status', email='$email', telephone='$telephone', office_hours='$officehours',username=$username',password=$pword where unique_id='id''";
			return $this->query($str_query);
		}
